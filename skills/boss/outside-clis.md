...
- One call per named participant per review cycle, in the background. Closed brief: every question batched, the diff or exact file excerpts inline, ending "verify only this; do not explore beyond these files."
